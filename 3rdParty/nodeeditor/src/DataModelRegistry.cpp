...
DataModelRegistry::RegisteredModelsMap const & DataModelRegistry::registeredModels() const
{
...
std::unique_ptr<NodeDataModel> DataModelRegistry::getTypeConverter(QString const &sourceTypeID, QString const &destTypeID) const
{
