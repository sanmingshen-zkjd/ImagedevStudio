...
public:
  ...
  void  registerModel(std::unique_ptr<ModelType> uniqueModel = std::make_unique<ModelType>(), QString const &category = "Nodes")
  {
  ...
  std::unique_ptr<NodeDataModel>   getTypeConverter(QString const &sourceTypeID,QString const &destTypeID) const;
