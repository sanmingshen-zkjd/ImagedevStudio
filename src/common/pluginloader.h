...
private:
    ...
    template <typename T> void initSection(Ui::ProjectConfigPrivate& ui)
    {
        ...
        QString secName = T::sectionName();
        QString space = QString::number(T::spacing());
        ...
        //_secNameMap.insert(std::make_pair(secName, secName));
    ...
    Array& _widgets;
  //  std::map<QString, QString> _secNameMap;
};
