...
typedef Context<BrightnessContrastGuiInt> BrightnessContrastCtx;
/**
*   @brief The class provides abstraction layer for CAN BUS hardware
*/
class BrightnessContrast : public QObject, public ComponentInterface {
    Q_OBJECT
    Q_DECLARE_PRIVATE(BrightnessContrast)
...
private:
    QScopedPointer<BrightnessContrastPrivate> d_ptr;
};